...
`}
            />
            <div style={styles.paraSpace}>
                <p>To get balance, you have to pass two header parameters one is <b>token-id</b> which is required and second <b>type</b>. type key value should be <b>BSV</b> or <b>STAS</b></p>
            </div>

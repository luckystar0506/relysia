        ...
        <div>
           <div style={styles.heading1Space}>
            ...
            <div style={styles.heading2Space}>
                <h4>(1.) Get StasTokenDetails</h4>
            </div>
            <div style={styles.paraSpace}>
                <p>you can get user StasTokenDetails by sending HTTP <b>GET</b> request to the stasTokenDetails URI </p>
            </div>
            <ApiUrlContainer title="https://api.vaionex.com/stasTokenDetails" />

            <div style={styles.heading2Space}>
                <h6>request</h6>
            </div>
            <ApiUrlContainer title="[GET] https://api.vaionex.com/stasTokenDetails" />
...
`}
            />
            <div style={styles.paraSpace}>
                <p>To get user StasTokenDetails, you have to pass one header parameters <b>tokenid</b></p>
            </div>
...
`}
            />
            <div style={styles.paraSpace}>
                <p>To generate token, you have to pass one header parameters <b>tokenid</b></p>
            </div>
    ...
    {
        "tokenSupply": 100,
        "destinationAddress": "1GakMzjx1jFXTPHNT2dmFvi1r7tfJE6nn4",
        "tokenDetails": {
            "tokenName": "test 9908",

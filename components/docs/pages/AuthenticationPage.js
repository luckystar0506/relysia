...
function AuthenticationPage(){
    ...
    return(
        <div>
            ...
            <div style={styles.paraSpace}>
                <p>you can create account for our app by sending HTTP <b>GET</b> request to the createUser URI </p>
            </div>
...
`}
  ...
  "data": {
    ...
    "msg": "Operation completed successfully"
            ...
            <div style={styles.paraSpace}>
                <p>In Now days,To validate genuine users most of apps uses otp validation. you can also validate by sending HTTP <b>GET</b> request to sendOTP URI</p>
            </div>
...
`}
            ...
            <div style={styles.heading2Space}>
             ...
             <div style={styles.paraSpace}>
                <p>If your request succeeds,  the server responds with an HTTP <b>200 OK</b>  status code and success message.</p>
            </div>
  ...
  "data": {
    ...
    "msg": "Verification code has been sent to your phone."
            ...
            <div style={styles.paraSpace}>
                <p>In Now days,To validate genuine users most of apps uses otp validation. you can also validate by sending HTTP <b>GET</b> request to validateOTP URI</p>
            </div>

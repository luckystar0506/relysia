...
function Dashboard(props) {
	...
	useEffect(() => {
		DB1.ref('stats/market_price_usd').once('value').then((snap) => {
			if (snap.val()) {
				setbsvRate(snap.val());
			}
		});
		...
		>
			...
			<DialogContent>
				<DialogContentText style={{ marginBottom: 0 }}>
					After the creation of Wallet, details can't be change.
				</DialogContentText>
		...
		>
			<Grid container style={{ padding: '0px 5%' }} justify="space-between">
				<Grid item xs={12} md={3}>
					<div
						style={{ backgroundColor: 'rgba(255,255,255,0.5)', margin: 20, marginTop: 10, padding: 10, borderRadius: 30 }}
					>
							...
							{walletsList.length === 0 && (
								...
								>
									<div style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
										...
										<Typography
											variant="h3"
											style={{ fontSize: '2.5rem', marginLeft: 'auto', fontWeight: 600 }}
										>
											₿
										</Typography>
									</div>
									...
									<div style={{ marginBottom: 12, cursor: 'pointer' }}>
										<Typography component="h4" variant="h4">
											<Skeleton
												variant="text"
												style={{ borderRadius: 10, width: '60%', height: 30 }}
											/>
										</Typography>
										<Typography component="h4" variant="subtitle2">
											<Skeleton
												variant="text"
												style={{ borderRadius: 10, width: '40%', height: 22 }}
											/>
										</Typography>
									</div>
						...
						>
							<Paper className={classes.accountBox1} style={{ width: matchesMDUp ? '100%' : '48%' }}>
								...
								>
									...
									<div
										style={{ marginTop: 15, marginBottom: 15, marginLeft: 5, textAlign: 'center' }}
									>
										<Typography
											style={{ color: theme.palette.textColors.para1, fontWeight: 500 }}
											variant="h3"
										>
									...
									<div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
										<RequestBSV
											...
											walletObj={
												walletsList && walletsList[selectedWallet] ? (
							...
							<Paper
								className={classes.accountBox1}
								style={{ width: matchesMDUp ? '100%' : '48%', maxHeight: '100%' }}
							>

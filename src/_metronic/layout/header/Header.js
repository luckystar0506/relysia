...
class Header extends React.Component {
  ...
  render() {
    const { headerContainerClasses, headerAttributes, headerClasses } = this.props;
    return (
      <div className={`kt-header kt-grid__item ${headerClasses}`} id="kt_header" {...headerAttributes} ref={this.headerCommonRef}>
        {/* <AnimateLoading /> */}
...
const mapStateToProps = (store) => ({
  ...
  headerFixedEnabled: objectPath.get(store.builder.layoutConfig, "header.self.fixed.desktop.enabled"),
  headerFixedDesktop: objectPath.get(store.builder.layoutConfig, "header.self.fixed.desktop"),
});
